...
import { createPaper, type PaperInput } from "@/lib/api";
  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <h2 className="mt-4 text-lg font-semibold">Paper Added</h2>
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Add a new research paper to your reading tracker.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Fill in the details about the research paper.
          </CardDescription>
        </CardHeader>
        <CardContent>
